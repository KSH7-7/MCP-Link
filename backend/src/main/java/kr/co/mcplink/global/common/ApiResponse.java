...
public record ApiResponse<T>(
	...
	public static <T> ApiResponse<T> success(String code, String message, List<T> data) {
		return new ApiResponse<>(Instant.now(), message, code, data);
	}

	public static <T> ApiResponse<T> success(String code, List<T> data) {
		return new ApiResponse<>(Instant.now(), "empty Message", code, data);
	}

	public static <T> ApiResponse<T> success(String code, String message) {
		return new ApiResponse<>(Instant.now(), message, code, List.of());
	}
